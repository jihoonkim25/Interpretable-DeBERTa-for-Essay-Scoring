...
function TextEditor3({  }) {
    ...
    const setScores=()=>{
        setCohesionScore(4);
        setSyntaxScore(3);
        setVocabularyScore(3);
        setPhraseologyScore(4);
        setGrammarScore(2);
        setConventionsScore(4);
        setOverallScore(3.5);
    }
    ...
    return (
            ...
            <div>
                ...
                <body>
                    ...
                    <h3><i class="material-icons" style={{color:"red"}}>flag</i>The model flagged 3 potential grammar error(s) on sentence 1 and 2.</h3>
                    <h3><i class="material-icons" style={{color:"red"}}>flag</i>The model flagged 1 potential conventions error(s) on sentence 1.</h3>
                </body>
                <table>
